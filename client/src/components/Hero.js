...
const Hero = ({ scrollToSection }) => {
  return (
    <section className="min-h-screen bg-gradient-to-br from-primary-100 via-primary-50 to-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
          <div className="text-left animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="bg-gradient-to-r from-primary-600 via-accent-500 to-rose-500 bg-clip-text text-transparent block mt-2">
                ZEKVIAN
              </span>
            </h1>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              ...
              <span className="text-primary-600 font-semibold bg-primary-100 px-2 py-1 rounded">
                Zekvian
              </span>{" "}
              delivers enterprise-grade solutions that scale with your
              ambitions.
            </p>
              ...
              <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl h-80 md:h-96 flex items-center justify-center relative overflow-hidden">
                <div className="text-center relative z-10">
                  ...
                  <p className="text-gray-900 font-bold text-xl mb-2">
                    Interactive{" "}
                    <span className="text-primary-600">Zekvian</span> Experience
                  </p>
